...
export const getOpenAI = async (url) => {
	...
	const promptParts = [
        ...
        \`\`\`
        Do not include any text, explanations, or comments outside the markdown code block. Ensure all numbers are integers or decimals, not strings.
        `,
        ...
        \`\`\`
        Do not include any text, explanations, or comments outside the markdown code block. Ensure all numbers are integers or decimals, not strings. Ensure the sum of traffic distribution percentages equals 100.
        `,
        ...
        \`\`\`
        Do not include any text, explanations, or comments outside the markdown code block. Ensure all numbers are integers or decimals, not strings. Ensure the sum of device distribution percentages equals 100.
        `,
	];
